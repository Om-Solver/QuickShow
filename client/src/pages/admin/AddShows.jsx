      ...
      <div className='w-full'>
        <div className='group flex gap-2 mt-4'>
          {nowPlayingMovies.map((movie) => (
            <div key={movie.id} className={`relative flex-1 min-w-0 cursor-pointer group-hover:not-hover:opacity-40 hover:-translate-y-1 transition duration-300`} onClick={() => setSelectedMovie(movie.id)}>
              <div className='relative rounded-lg overflow-hidden'>
                <img src={movie.poster_path} alt="" className='w-full aspect-[2/3] object-cover brightness-90' />
